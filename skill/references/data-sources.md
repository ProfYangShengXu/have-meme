...
**三路并行 + RRF（Reciprocal Rank Fusion，倒数排名融合）**，k=60：

| 路 | 实现 | 抓什么 |
|---|---|---|
| `route_pinyin` | 拼音 2-3gram 倒排，得分 = 匹配长度² | 谐音 / 同音梗 |
| `route_shape` | 部首集合重叠 + 汉字序列子串 | 字形 / 拆字梗 |
| `route_bm25` | jieba 分词 + BM25Okapi | 主题 / 关键词 |
